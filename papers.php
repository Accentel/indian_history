...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="donate.html" class="nav-link">Videos</a></li>
                    <li class="nav-item"><a href="records.php" class="nav-link">Authenticate Records</a></li>
                    <li class="nav-item active"><a href="papers.php" class="nav-link">Research papers</a></li>
    ...
    <div class="hero-wrap" style="background-image: url('images/papers.jpg');" data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                    <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.html">Home</a></span> <span>Research Papers</span></p>
                    <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Research Papers</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="ftco-section ftco-gallery">
        <div class="container">
            <div class="row">
                <?php $a = "select * from papers order by id desc";
