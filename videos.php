...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a href="videos.php" class="nav-link">Videos</a></li>
    ...
    <div class="hero-wrap" style="background-image: url('images/videos.jpg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section ftco-gallery">
        <div class="container">
            <div class="row video-div">
                <?php $a = "select * from videos order by id desc";
                $sq = mysqli_query($link, $a);
                $i = 1;
                while ($r = mysqli_fetch_array($sq)) {
                ?>
                    <div class="col-lg-6 col-md-12 col-xs-12 video-div">
                        <iframe height="400" width="500" src="<?php echo $r['videolink']; ?>">

                        </iframe>
                        <div class="videotext"><?php echo $r['name']; ?></div>
                    </div>
