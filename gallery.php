...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="gallery.php" class="nav-link">Photos</a></li>
  ...
  <div class="hero-wrap" style="background-image: url('images/photos.jpg');" data-stellar-background-ratio="0.5">
  ...
  <section class="ftco-section ftco-gallery">
    <div class="container">
      <div class="row">
        ...
        ?>
          <a href="upload/gallery/<?php echo $r['image']; ?>" class="col-lg-3 col-md-4 col-xs-6 image-popup gallery-img"> <img src="upload/gallery/<?php echo $r['image']; ?>" class="img-tag" /></a>
        <?php } ?>
      </div>
    </div>
  </section>
